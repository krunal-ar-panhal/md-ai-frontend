  ...
  return (
    <div className='bg-primary-light mt-5 rounded text-base'>
      <div className='px-6 py-4 space-y-5'>
        ...
        <p className='text-text-dark mt-2'>Selecte Items: {selectedItems}</p>
        ...
        <div className='px-4 mb-6'>
            ...
            <button className='bg-green-600 px-3 py-1.5 text-white mt-2 rounded-md flex justify-between items-center mb-4'><span className='mr-5'>Procced to checkout</span><i className='ri-bank-card-line'></i></button>
        </div>
      </div>
    </div>
  )
