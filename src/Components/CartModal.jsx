              ...
              products.map((item, index) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <h5 className="textl font-medium">{item.name}</h5>
                    ...
                    <div className="flex flex-row md:justify-start justify-end items-center mt-2">
                      <button
                        onClick={() =>
                          handleQuantity({ type: "decrement", id: item._id })
                        }
                      ...
                      <button
                        onClick={() =>
                          handleQuantity({ type: "increment", id: item._id })
                        }
